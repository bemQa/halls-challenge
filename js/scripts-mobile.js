$(document).ready(function () {
    ...
    $('.btn-breathe').on('click', function() {
        ...
        $('.vjs-video-canvas').on('touchstart', function() {
            $('.arrows-360').addClass('hide');
        });
    });
    ...
    $('.go-to-block2').click(function(e) {
        ...
        setTimeout(function() {
            ...
            setTimeout(function() {
                ...
                $('.preloader2').fadeIn();
                $('.block2').remove();
                $('.block3').delay(3000).fadeIn();
                // таймер запуска видео3 после появления блока3
                setTimeout(function() {
    ...
    (function(window, videojs) {
        ...
        player.panorama({
            ...
            initFov: 100,
            NoticeMessage: (isMobile())? "Вращайте видео движениями пальцев" : "Вращайте видео движениями мыши",
            callback: function () {
